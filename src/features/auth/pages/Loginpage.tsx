      ...
      <div className="tf-panel-left">
        <div className="tf-panel-left__inner">
          ...
          <div className="tf-panel-left__content">
            ...
            <p>The intelligent resume sourcing & shortlisting platform built for modern recruiters.</p>
          ...
          <div className="tf-panel-left__footer">
            Trusted by 2,400+ recruiting teams worldwide
          </div>
        </div>
        ...
        <div className="tf-form-wrapper">
          ...
          {mode === 'login' ? (
            <>
              ...
              <form className="tf-form" onSubmit={handleLogin} noValidate>
                <div className={`tf-field ${emailError ? 'tf-field--error' : ''}`}>
                  <label htmlFor="email">Email address</label>
                  <div className="tf-input-wrap">
                    <span className="tf-input-icon">
                  ...
                  {emailError && <span className="tf-error-msg">{emailError}</span>}
                </div>
                ...
                <div className={`tf-field ${passwordError ? 'tf-field--error' : ''}`}>
                  ...
                  {passwordError && <span className="tf-error-msg">{passwordError}</span>}
                </div>
            ...
            <>
              <button className="tf-back-btn" onClick={() => { setMode('login'); setForgotStatus(null); setForgotEmail(''); }}>
                <svg width="18" height="18" fill="none" viewBox="0 0 24 24">
              ...
              <div className="tf-form-header">
                <div className="tf-forgot-icon">
                  <svg width="28" height="28" fill="none" viewBox="0 0 24 24">
                    ...
                    <path d="m22 6-10 7L2 6" stroke="#2563EB" strokeWidth="1.8" strokeLinecap="round"/>
                  </svg>
                </div>
              ...
              <form className="tf-form" onSubmit={handleForgotPassword} noValidate>
                <div className={`tf-field ${forgotStatus?.type === 'error' ? 'tf-field--error' : ''}`}>
                  ...
                  <div className="tf-input-wrap">
                    ...
                    <input
                      ...
                      placeholder="you@company.com"
                      value={forgotEmail}
                      onChange={(e) => { setForgotEmail(e.target.value); setForgotStatus(null); }}
                      autoComplete="email"
                    />
                  </div>
                </div>
                ...
                {forgotStatus && (
                  <div className={`tf-alert tf-alert--${forgotStatus.type}`}>
                    <svg width="16" height="16" fill="none" viewBox="0 0 24 24">
                ...
                <button type="submit" className="tf-submit-btn" disabled={forgotLoading}>
                  {forgotLoading ? (
                    <span className="tf-spinner" />
                  ) : (
                    <>
                      Send reset link
                      <svg width="18" height="18" fill="none" viewBox="0 0 24 24">
                        <path d="M22 2 11 13M22 2 15 22 11 13 2 9l20-7z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </>
                  )}
                </button>
